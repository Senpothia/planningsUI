...
public class SuiteAux {
	...
	public SuiteAux(Integer id, String nom, Integer idAuteur, String nomAuteur, LocalDateTime date, String stringDate,
			Integer numero, Boolean actif, String actifString, Integer idProjet,
			com.michel.plannings.models.ProjetAux projet, com.michel.plannings.models.PhaseAux phase,
			List<NoteAux> notes) {
		super();
		this.id = id;
		this.nom = nom;
